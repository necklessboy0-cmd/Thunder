...
with st.sidebar:
    ...
    st.caption("Web research and source discovery.")
...
if submitted:
    ...
    with st.spinner("🔎 Research Guide is searching the web..."):
    ...
    st.success(
        f"Research Guide found {len(results)} web result(s)."
    )
